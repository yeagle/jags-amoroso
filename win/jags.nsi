!define APP_NAME "JAGS-amoroso"
!define PUBLISHER "JAGS-amoroso"

;Name used for JAGS Amoroso module registry keys
...
!define UNINSTALL_LOG "Uninstall-amoroso"
...
Section #Default section
   ...
   WriteRegStr ${INSTDIR_REG_ROOT} "${INSTDIR_REG_KEY}" "URLInfoAbout" "https://github.com/yeagle/jags-amoroso"
...
Section "32-bit installation" Sec32
   ...
   File /r inst32\lib\JAGS\modules-${MAJOR}\amoroso*
...
Section "64-bit installation" Sec64
   ...
   !insertmacro UNINSTALL.LOG_OPEN_INSTALL
   File /r inst64\lib\JAGS\modules-${MAJOR}\amoroso*
   !insertmacro UNINSTALL.LOG_CLOSE_INSTALL
